...
nll_distRemoval <- function(beta, n_param, yDistance, yRemoval, mixture, keyfun, Xlam, A, Xphi, Xrem, Xdist, db, a, u, w, k, lfac_k, lfac_kmyt_dist, kmyt_dist, lfac_kmyt_rem, kmyt_rem, Kmin, threads) {
    .Call(`_unmarked_nll_distRemoval`, beta, n_param, yDistance, yRemoval, mixture, keyfun, Xlam, A, Xphi, Xrem, Xdist, db, a, u, w, k, lfac_k, lfac_kmyt_dist, kmyt_dist, lfac_kmyt_rem, kmyt_rem, Kmin, threads)
}
