...
\begin{figure}[!h]
\centering
\includegraphics[width=4in,height=4in]{dynocc-sim.pdf}
...
<<yearlysim,fig=true,include=false,width=3,height=7>>=
...
\begin{figure}
  \centering
  \includegraphics[width=3in,height=7in]{dynocc-yearlysim.pdf}
...
<<gof,echo=false,fig=true,include=false,width=6,height=6>>=
...
\begin{figure}[!h]
\centering
\includegraphics[width=4in,height=4in]{dynocc-gof.pdf}
...
<<cov,fig=true,include=false,width=6,height=3>>=
...
E.p$dateOrig <- E.p$date*sd.DATE + mean.DATE1
...
\begin{figure}[!h]
\centering
\includegraphics[width=6in,height=3in]{dynocc-cov.pdf}
\caption{Covariates}
\label{fig:cov}
\end{figure}
