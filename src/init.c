...
extern SEXP nll_occuMulti( SEXP fStartR, SEXP fStopR, SEXP dmFr, SEXP dmOccR, SEXP betaR, SEXP dmDetR, SEXP dStartR, SEXP dStopR, SEXP yR, SEXP yStartR, SEXP yStopR, SEXP Iy0r, SEXP zR );
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"nll_occuMulti",   (DL_FUNC) &nll_occuMulti,   13},
