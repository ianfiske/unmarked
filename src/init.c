...
extern SEXP nll_nmixTTD( SEXP beta_, SEXP y_, SEXP delta_, SEXP W_, SEXP V_, SEXP pind_, SEXP dind_, SEXP tdist_, SEXP N_, SEXP J_, SEXP K_, SEXP naflag_);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"nll_nmixTTD",     (DL_FUNC) &nll_nmixTTD,     12},
